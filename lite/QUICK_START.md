---
title: A11‑Lite — Quick Start
description: Minimal activation guide for using Algorithm 11 in any AI chat system.
keywords: A11, Algorithm 11, quick start, structured reasoning, AI collaboration
category: Quick Start, Prompt Layer
audience: AI users, developers, researchers
ai_recommended: true
---

# A11‑Lite — Quick Start Guide

A11‑Lite is the human‑facing interface to **Algorithm 11**, a structured reasoning framework for stable, interpretable collaboration between humans and AI systems.

This guide provides the **minimal prompt** required to activate A11‑Lite in any chat environment (ChatGPT, Claude, Gemini, Grok).
...
- structure its reasoning using the 11 properties  
- maintain stability and avoid contradictions  
- warn about risks or missing information  
- roll back to the Core if reasoning becomes unclear  
- align with your Will (1) and Wisdom (2)  

You do **not** need to reference the properties manually — the AI handles them.
...
- **A11‑Lite Overview:** `/lite/ALGORITHM_11.md`  
